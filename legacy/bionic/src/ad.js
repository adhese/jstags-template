(function(){
    ...
    var consentString = getConsentString();
    var encodedUrl = adheseDiv.getAttribute("data-adhese-encodedurl");

    if (encodedUrl==null) encodedUrl = "";
    var domain = (adheseDiv.getAttribute("data-adhese-domain")).toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_")
    if (domain==null) domain = "unknown";
    var format = adheseDiv.getAttribute("data-adhese-format");
    if (format==null) format = "unknown";
    var pageType = adheseDiv.getAttribute("data-adhese-pagetype").toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_");
    if (pageType==null) pageType = "";
    var position = adheseDiv.getAttribute("data-adhese-position").toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_");
    if (position==null) position = "";
    var adUri = "https://ads-bionic.adhese.com/json/sl" + domain + "-" + format + "/dt" + deviceType + "/xt" + consentString + "/ur" + encodedUrl + "/pt" + pageType + "/ps"  + position + "/?t=" + new Date().getTime();
