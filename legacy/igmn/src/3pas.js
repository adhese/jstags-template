...
/*    else if (window.innerWidth < 1025) {
    ...
    var adUri = "https://ads-igmn.adhese.com/json/sl" + (adheseDiv.getAttribute("data-adhese-adunit")).toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_") + "/dt" + deviceType + "/xt" + consentString + "/xb" + appId + "/ur" + encodedUrl + "/xf" + b64Url + "/?t=" + new Date().getTime();
