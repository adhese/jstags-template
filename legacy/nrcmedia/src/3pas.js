...
/*    else if (window.innerWidth < 1025) {
    ...
    var adUri = "https://ads-nrcmedia.adhese.com/json/sl" + (adheseDiv.getAttribute("data-adhese-adunit")).toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_") + "-" + size + "/dt" + deviceType + "/?t=" + new Date().getTime();
    AdheseAjax.request({
        url: adUri,
        method: 'get',
        json: true
