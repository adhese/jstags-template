var VpaidVideoPlayer = function() {
  ...
  VpaidVideoPlayer.prototype.overlayOnClick_ = function() {
    this.eventsCallbacks_['AdClickThru'](
      (this.parameters_.clickTag ? this.parameters_.clickTag + this.parameters_.clickDestinationUrl : this.parameters_.clickDestinationUrl),
      this.parameters_.impressionId,
      true);
  };
