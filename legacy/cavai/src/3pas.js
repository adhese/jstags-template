...
/*    else if (window.innerWidth < 1025) {
    ...
    var adUri = "https://ads-cavai.adhese.com/json/sl" + (adheseDiv.getAttribute("data-adhese-adunit")).toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_") + "/dt" + deviceType + "/?t=" + new Date().getTime();
    AdheseAjax.request({
        url: adUri,
        method: 'get',
        json: true
        ...
        for (var i = result.length - 1; i >= 0; i--) {
            if (result[i].ext == 'zip') {
                ...
                if(clickTag) {
                    ...
                    var thirdPartyClickTag = clickTag + 'https://ads-cavai.adhese.com/raylene/';
                    toInsertInBody = toInsertInBody.replace('https://ads-cavai.adhese.com/raylene/', thirdPartyClickTag);
                }
