...
function initMoatTracking(b,c,l,p,g){var m=document.createElement("script"),f={events:[],addEvent:function(a){d.sendEvent?(f.events&&(d.sendEvent(f.events),f.events=!1),d.sendEvent(a)):f.events&&f.events.push(a)}},a=function(a){return function(){var d=-1,h;b&&b.getAdVolume&&(h=b.getAdVolume());"number"==typeof h&&!isNaN(h)&&0<=h&&(d=h);f.addEvent({type:a,adVolume:d});if(-1!==t.indexOf(a)&&b&&b.unsubscribe&&!q){q=!0;for(var c in e)if(e.hasOwnProperty&&e.hasOwnProperty(c))try{b.unsubscribe(e[c],c)}catch(g){}}}},
d={vidIntType:"5",vidIntVersion:"1.0",adData:{ids:l,vpaid:b,build:"b8ef28a-clean"},dispatchEvent:f.addEvent,clientCallback:g};g="_moatApi"+Math.floor(1E8*Math.random());var e={AdStarted:a("AdStarted"),AdStopped:a("AdStopped"),AdSkipped:a("AdSkipped"),AdLoaded:a("AdLoaded"),AdLinearChange:a("AdLinearChange"),AdSizeChange:a("AdSizeChange"),AdExpandedChange:a("AdExpandedChange"),AdSkippableStateChange:a("AdSkippableStateChange"),AdDurationChange:a("AdDurationChange"),AdRemainingTimeChange:a("AdRemainingTimeChange"),
AdVolumeChange:a("AdVolumeChange"),AdImpression:a("AdImpression"),AdClickThru:a("AdClickThru"),AdInteraction:a("AdInteraction"),AdVideoStart:a("AdVideoStart"),AdVideoFirstQuartile:a("AdVideoFirstQuartile"),AdVideoMidpoint:a("AdVideoMidpoint"),AdVideoThirdQuartile:a("AdVideoThirdQuartile"),AdVideoComplete:a("AdVideoComplete"),AdUserAcceptInvitation:a("AdUserAcceptInvitation"),AdUserMinimize:a("AdUserMinimize"),AdUserClose:a("AdUserClose"),AdPaused:a("AdPaused"),AdPlaying:a("AdPlaying"),AdError:a("AdError")},
q=!1,t=["AdStopped","AdSkipped","AdVideoComplete"],a="z",u="#"+g,r="";(function(){if(b&&b.subscribe)for(var a in e)e.hasOwnProperty&&e.hasOwnProperty(a)&&b.subscribe(e[a],a)})();var k,n;try{k=c.ownerDocument,n=k.defaultView||k.parentWindow}catch(v){k=document,n=window}n[g]=d;m.type="text/javascript";c&&c.insertBefore(m,c.childNodes[0]||null);"1698"===l.zMoatAdvertiser&&(a="sejs",p+="_nlsn",r="?moatClientLevel1="+l.level1);m.src="https://"+a+".moatads.com/"+p+"/moatvideo.js"+r+u;return d};
