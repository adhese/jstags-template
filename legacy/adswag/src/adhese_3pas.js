...
/*    else if (window.innerWidth < 1025) {
    ...
    var adUri = "https://ads-adswag.adhese.com/json/sl" + (adheseDiv.getAttribute("data-adhese-adunit")).toLowerCase().replace(/\//g,"_").replace(/\(/g,"_").replace(/\)/g,"_") + "/dt" + deviceType + "/xt" + consentString + "/xb" + appId + "/ur" + encodedUrl +"/?t=" + new Date().getTime();
        ...
        for (var i = result.length - 1; i >= 0; i--) {
            if (result[i].ext == 'zip') {
                ...
                if(clickTag) {
                    ...
                    var thirdPartyClickTag = clickTag + 'https://ads-adswag.adhese.com/raylene/';
                    toInsertInBody = toInsertInBody.replace('https://ads-adswag.adhese.com/raylene/', thirdPartyClickTag);
                }
