    ...
    var adUri = "https://ads-" + adheseDiv.getAttribute("data-adhese-account") + ".adhese.com/json/sl" + (adheseDiv.getAttribute("data-adhese-adunit")).replace(/\//g,"_") + '-' + adheseDiv.getAttribute("data-adhese-slot") + '/tlall' + '/xs' + adheseDiv.getAttribute("data-adhese-advertiserid") + '/cx' + adheseDiv.getAttribute("data-adhese-cxsegments").replace(/,/g, ';') + "/?t=" + new Date().getTime();
